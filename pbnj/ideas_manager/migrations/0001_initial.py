...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ideas_manager_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('order', self.gf('django.db.models.fields.CharField')(default='', max_length=2)),
        ))
        db.send_create_signal('ideas_manager', ['UserProfile'])

    def backwards(self, orm):
        # Deleting model 'idea'
        db.delete_table('ideas_manager_idea')

        # Deleting model 'UserProfile'
        db.delete_table('ideas_manager_userprofile')
